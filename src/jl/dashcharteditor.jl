...
export dashcharteditor

"""
    dashcharteditor(;kwargs...)
...
"""
function dashcharteditor(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dashcharteditor", "DashChartEditor", "dash_chart_editor", available_props, wild_props; kwargs...)
end
